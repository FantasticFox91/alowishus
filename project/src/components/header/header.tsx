  ...
  return (
    <header className='page-header'>
      ...
      <ul className="page-header__list">
        ...
        <li className="page-header__item">
          <a className="page-header__link" href="#">Find Us</a>
        </li>
        <li className="page-header__item">
          <a className="page-header__link" href="#">Alowishus Catering</a>
        </li>
      </ul>
      <div className="page-header__user-buttons">
        <button className='page-header__button page-header__button--cart' type='button'></button>
